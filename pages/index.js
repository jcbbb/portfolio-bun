...
export function render() {
  ...
  <html lang="en">
    <head>
      <meta charset="UTF-8" />
      <meta name="description" content="Building websites that are both beautiful and functional." />
      <meta name="viewport" content="width=device-width" />

      <!-- Open Graph / Facebook -->
      <meta property="og:type" content="website" />
      <meta property="og:url" content="https://portfolio.homeless.dev" />
      <meta property="og:title" content="Avazbek Juraev - Software Engineer" />
      <meta property="og:description" content="Building websites that are both beautiful and functional." />
      <meta property="og:image" content="/public/images/homepage.webp" />
      <!-- Twitter -->
      <meta property="twitter:card" content="summary_large_image" />
      <meta property="twitter:url" content="https://portfolio.homeless.dev" />
      <meta property="twitter:title" content="Avazbek Juraev - Software Engineer" />
      <meta property="twitter:description" content="Building websites that are both beautiful and functional." />
      <meta property="twitter:image" content="/public/images/homepage.webp" />

      <link rel="stylesheet" href="/public/css/main.min.css" type="text/css" media="screen" />
      <title>Avazbek Juraev - Software Engineer</title>
    </head>
    <body class="bg-gruvbox-fg">
      <div class="flex max-w-screen-xl md:px-12 lg:px-24 flex-col md:flex-row md:space-x-12 w-full mx-auto justify-between">
        <aside class="md:sticky top-0 h-full pt-16 md:py-24 flex flex-col md:min-h-screen">
          ...
          <nav class="mt-12 lg:mt-20 hidden md:block">
          ...
          <ul class="flex gap-3 mt-4 md:mt-auto py-4 px-6 md:px-0">
            <li>
              <a class="text-gruvbox-black block p-2 -m-2 duration-500 hover:text-gruvbox-purple" href="https://github.com/jcbbb">
            ...
            <li>
              <a class="text-gruvbox-black block p-2 -m-2 duration-500 hover:text-gruvbox-purple" href="https://linkedin.com/in/avazbek-juraev">
            ...
            <li>
              <a class="text-gruvbox-black block p-2 -m-2 duration-500 hover:text-gruvbox-purple" href="https://jcbbb.t.me">
